...
# ファイルの読み込み
file_path_0 = "E:/tagawa/20241203/room1_ch1ch2_220mK_920uA920uA_gain5_trig0.2V_rate500k_samples100k/CH0_pulse/output0.csv"  # output0のファイル名
file_path_1 = "E:/tagawa/20241203/room1_ch1ch2_220mK_920uA920uA_gain5_trig0.2V_rate500k_samples100k/CH1_pulse/output1.csv"  # output1のファイル名
...
if base_0 is not None and base_1 is not None:
    ...
    plt.scatter(height_base_0, height_base_1, alpha=0.7)
    plt.title('Scatter Plot: (height - base) for output0 vs output1')
    plt.xlabel('output0 - (height - base)')
    plt.ylabel('output1 - (height - base)')
    plt.grid(True)
    plt.show()

    plt.figure(figsize=(8, 8))
    plt.scatter(rise_0, height_0, alpha=0.7)
    plt.title('Scatter Plot: (height - base) for output0 vs output1')
    plt.xlabel('output0 - (height - base)')
    plt.ylabel('output1 - (height - base)')
    plt.grid(True)
